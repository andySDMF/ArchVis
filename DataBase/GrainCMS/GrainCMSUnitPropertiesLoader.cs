...
public class GrainCMSUnitPropertiesLoader : GrainCMSLoader
{
    [Header("Grain CMS Properties")]
    [SerializeField]
    ...
    {
        using (UnityWebRequest request = UnityWebRequest.Get("https://cms.grain.london/api/projects/" + projectID + "/plot-properties?token=" + apiToken))
        {
            request.timeout = 5;
