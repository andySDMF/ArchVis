...
public class EaseScale : MonoBehaviour, IEase
{
    [Header("Ease In")]
    [SerializeField]
    ...
    public bool State
    {
        get
        {
            if (transform != null)
            {
                return (transform.localScale.Equals(easeInSettings.start)) ? false : true;
            }
            else return false;
        }
    }
    ...
    public void Jump(bool state)
    {
        ...
        if (state)
        {
            transform.localScale = easeInSettings.start;
        }
        else
        {
            transform.localScale = easeOutSettings.start;
        }
    }
